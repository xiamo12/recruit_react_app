...
var _initialiseProps = function _initialiseProps() {
  ...
  this.getAnimData = function (props, key, i, enterOrLeave, startOrEnd) {
     ...
     */
    return props.animConfig ? _this6.getTweenAnimConfig((0, _utils.transformArguments)(props.animConfig, key, i)[enterOrLeave], startOrEnd, enterOrLeave) : _this6.getTweenType((0, _utils.transformArguments)(props.type, key, i)[enterOrLeave], startOrEnd);
  };
  ...
  this.performEnter = function (key, i) {
    var interval = (0, _utils.transformArguments)(_this6.props.interval, key, i)[0];
    var delay = (0, _utils.transformArguments)(_this6.props.delay, key, i)[0];
    _this6.placeholderTimeoutIds[key] = _rcTweenOne.ticker.timeout(_this6.performEnterBegin.bind(_this6, key), interval * i + delay);
  ...
  this.performEnterBegin = function (key) {
    ...
    _rcTweenOne.ticker.clear(_this6.placeholderTimeoutIds[key]);
  ...
  this.leaveComplete = function (key, e) {
    ...
    if (!needLeave) {
      var currentChildren = (0, _utils.toArrayChildren)((0, _utils.getChildrenFromProps)(_this6.props));
      _this6.setState({
