...
var _initialiseProps = function _initialiseProps() {
  ...
  this.getAnimData = function (props, key, i, enterOrLeave, startOrEnd) {
     ...
     */
    return props.animConfig ? _this6.getTweenAnimConfig(transformArguments(props.animConfig, key, i)[enterOrLeave], startOrEnd, enterOrLeave) : _this6.getTweenType(transformArguments(props.type, key, i)[enterOrLeave], startOrEnd);
  };
  ...
  this.performEnter = function (key, i) {
    var interval = transformArguments(_this6.props.interval, key, i)[0];
    var delay = transformArguments(_this6.props.delay, key, i)[0];
    _this6.placeholderTimeoutIds[key] = ticker.timeout(_this6.performEnterBegin.bind(_this6, key), interval * i + delay);
  ...
  this.performEnterBegin = function (key) {
    ...
    ticker.clear(_this6.placeholderTimeoutIds[key]);
  ...
  this.leaveComplete = function (key, e) {
    ...
    if (!needLeave) {
      var currentChildren = toArrayChildren(getChildrenFromProps(_this6.props));
      _this6.setState({
